...
export function AnnouncementBanner() {
  return (
    <section
      className="section-wrapper relative z-20 w-full"
      style={{ paddingTop: '70px' }}
    >
      <div
        className="w-full border-y border-[rgba(255,215,0,0.28)]"
        style={{
          background:
      ...
      >
        <div className="mx-auto flex min-h-[52px] max-w-6xl flex-col items-center justify-center gap-2 px-4 py-3 text-center sm:px-6 md:flex-row md:gap-4 md:py-2">
          ...
          >
            Explore practical AI lessons for job searching, work and business.
          </p>
          ...
          >
            Browse Free Lessons <ArrowRight size={16} />
          </motion.a>
        </div>
      </div>
    </section>
