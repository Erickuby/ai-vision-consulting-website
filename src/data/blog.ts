...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription: 'Agent Mode lets Copilot do the work inside your file instead of suggesting it. What it handles well, where it still fails, and how to check what it produced.',
  ...
  },
  {
    ...
    metaDescription: 'Two Copilot agents handle deep research and data analysis at work. What each one is genuinely good at, when to use them, and how to check what comes back.',
    keywords: ['Copilot Researcher agent', 'Copilot Analyst agent', 'Microsoft 365 Copilot agents'],
  },
  {
    slug: 'copilot-cowork-and-credits',
    title: 'Copilot Cowork and Credits: What Agentic Work Costs and How to Control It',
    excerpt: 'Cowork hands Copilot the whole task rather than a draft, and charges by how hard the task was. A plain guide to the model, the costs and the controls.',
    ...
    metaDescription: 'Copilot Cowork runs whole tasks start to finish and bills by usage. What it does, how Copilot Credits are priced, and how to keep the spend predictable.',
