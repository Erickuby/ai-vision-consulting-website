...
const routes = [
  ...
  },
  {
    ...
    faqs: [
      { question: 'Where can I buy the books?', answer: 'On Amazon. Copilot Prompts is on sale as a Kindle eBook at £4.99, also in Kindle Unlimited, and as a £9.99 paperback. Copilot for Excel is on sale as a Kindle eBook at £4.99, also in Kindle Unlimited, and its paperback is in review.' },
      ...
      { question: 'When was Copilot for Excel published?', answer: 'The Kindle edition went on sale on Amazon on 23 September 2026. The 86 page paperback was submitted the same day and is in review, which can take up to 72 hours.' },
