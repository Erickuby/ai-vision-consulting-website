...
meta_title: "Does Your Website Need an AI Chatbot? Checklist"
meta_description: "Use this practical checklist to decide whether your website needs an AI chatbot, what to prepare, how to manage risk and what to measure before buying."
...
image_alt: "A website chatbot interface with routes to automated and human support."
...
The [Information Commissioner's Office guidance on AI and data protection](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/) is a useful starting point for UK organisations. Requirements depend on your circumstances, so seek qualified advice where needed. This article is not legal advice.
...
If the case is clear, [discuss a chatbot trained on your website and documents](https://www.fiverr.com/kubblicious/build-an-ai-chatbot-trained-on-your-documents-and-website). For broader options, see [small business AI automation](/small-business-ai-automation/).
